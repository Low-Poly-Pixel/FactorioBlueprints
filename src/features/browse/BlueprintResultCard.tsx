...
export const BlueprintResultCard = ({
  ...
  <li>
    <Link
      className={`block ${blueprintCardShellClassName} transition hover:-translate-y-0.5 hover:bg-[color-mix(in_oklch,var(--card),var(--primary)_30%)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.4)]`}
